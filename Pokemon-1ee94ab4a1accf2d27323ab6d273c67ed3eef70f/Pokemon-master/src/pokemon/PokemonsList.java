...
public class PokemonsList {
    public Pokemon charmander = new Pokemon("Charmander", 39, 42, 53, Type.FIRE, new Punch(), new FireBreath(),PokemonName.CHARMANDER);
    public Pokemon bulbasaur = new Pokemon("Bulbasaur", 45, 49, 49, Type.PLANT, new Punch(), new Overgrow(),PokemonName.BULGASAUR);
    public Pokemon pikachu = new Pokemon("Pikachu", 35, 40, 55, Type.AIR, new Punch(), new LightningBolt(),PokemonName.PIKACHU);
    public Pokemon squirtle = new Pokemon("Squirtle", 44, 66, 48, Type.WATER, new Punch(), new Torrent(),PokemonName.SQUIRTLE);
    public Pokemon diglett = new Pokemon("Diglett", 10, 25, 55, Type.EARTH, new Punch(), new SandForce(),PokemonName.DIGGLET);
